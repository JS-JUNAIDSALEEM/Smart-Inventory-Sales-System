...
# DATA INITIAL LOADING
    ...
    def load_database(self):
        try:
            ...
            print("No previous records found. Starting with fresh default stock!")
...
#  5. DELETE ITEM
    ...
    def delete_item(self):
        ...
        if item_to_delete in self.inventory:
            ...
            print(f"Success: {item_to_delete.capitalize()} has been removed from the inventory records!")
        else:
